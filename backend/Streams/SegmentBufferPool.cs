...
public sealed class SegmentBufferPool
{
    ...
    /// managed heap on a container capped at 512 MB.</summary>
    ...
    private static long ReadMaxIdleBytesFromEnvironment()
    {
        ...
        // Unset: size retention from the heap ceiling rather than the fixed 512 MB, which on a
        // 512 MB container is the whole managed heap and leaves nothing for the streams it serves.
