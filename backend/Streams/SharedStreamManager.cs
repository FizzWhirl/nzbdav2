...
public static class SharedStreamManager
{
    ...
    /// <summary>
    /// Get the number of readers currently attached across all shared entries.
    /// </summary>
    public static int ActiveReaderCount => s_entries.Values.Sum(entry => entry.ReaderCount);
}
