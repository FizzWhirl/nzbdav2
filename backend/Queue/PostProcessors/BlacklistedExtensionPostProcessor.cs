...
{
    /// <summary>
    /// Backwards-compatible entry point kept so <c>QueueItemProcessor.cs</c> does not need to change
    /// (that file is out of scope for this adaptation). Delegates to <see cref="RemoveFilteredFiles"/>.
    /// </summary>
    public void RemoveBlacklistedExtensions() => RemoveFilteredFiles();
