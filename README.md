...
*   **Health**: HEAD health checks now use the smart header-analysis path before falling back to a full segment scan, and a timed-out urgent HEAD check is demoted to an immediate quick STAT check instead of looping through another 30-minute HEAD retry.
