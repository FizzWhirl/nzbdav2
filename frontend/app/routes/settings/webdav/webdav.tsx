        ...
        <div className={styles.container}>
            ...
            <Form.Group>
                ...
                <Form.Text id="max-graceful-degradation-segments-help" muted>
                    ...
                    <br /><br />
                    <strong>Per-container override (not configurable):</strong> the configured value applies to <em>resilient</em> containers (MKV / WebM / MPEG-TS / fragmented MP4). For <em>standard</em> containers (MP4 / MOV / AVI / WMV / FLV), the effective cap is hard-limited to <code>min(configured, 2)</code> because their structural metadata (moov / index boxes) is sensitive to byte-offset corruption. For <em>unknown / non-video</em> files the cap is fixed at <code>0</code> (truncate on the first failure).
                </Form.Text>
            </Form.Group>
            <hr />
            <Form.Group>
