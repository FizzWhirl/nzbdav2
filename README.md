...
*   **Fix**: Repairs now explicitly trigger Sonarr/Radarr replacement searches after deleting the failed media file, even when the original grab was successfully marked failed/blocklisted in Arr history.
